                    ...
                    <Form className="form-search-group" onSubmit={this.handleSearch}>
                            <FormItem  {...formItemLayout} label="手机号" extra="" >
                                {getFieldDecorator('phone', {
                                    rules: [{ required: true, message: '请输入在优课优信注册的手机号' },{
                                        validator: this.checkAccount,
                                    }],
                                })(
                                    <Input placeholder="请输入在优课优信注册的手机号" style={{ width: '100%' }}/>
                                )}
                            </FormItem>
                            ...
                            <FormItem {...formItemLayout} label="姓名" >
                                {getFieldDecorator('name', {
                                    rules: [{
                                        required: true, message: '请输入在优课优信注册的姓名',
                                    }],
                                })(
                                    <Input placeholder="请输入在优课优信注册的姓名"/>
                                )}
                            </FormItem>
                            ...
                            <FormItem label="头像" {...formItemLayout}  extra="头像大小不超过2M，画面清晰，建议尺寸比例为1：1">
                                <span style={{position:'relative',right:'46px',fontSize:12,color:'#f04134',fontFamily: 'SimSun'}}>*</span>
                                <ThumbUpload upload={(value)=>{this.getUploadUrl(value)}} cover={this.state.cover} type={true} cropRate="1:1" size={true}/>
                            </FormItem>
