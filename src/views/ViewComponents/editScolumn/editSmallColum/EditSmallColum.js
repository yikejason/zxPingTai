...
import GetQrcode from "../../../publicComponents/getQrcode";
 ...
 class EditSmallColum extends Component{
  ...
  render(){
    const {tags,speakerList,editStatus,id,ID,contentType,preview} = this.state;
          ...
          <Form onSubmit={this.handleSubmit} className="login-form">
            ...
            <FormItem {...formItemLayout} label="小集标题">
              {getFieldDecorator('title', {
                ...
                <Input placeholder="点击输入小集标题" maxLength="30"/>
              )}
            </FormItem>
            <FormItem {...formItemLayout} label="主讲人">
              {getFieldDecorator('speaker', {
                ...
                <Input placeholder="请输入主讲人姓名" maxLength="30"/>
                  
              )}
            </FormItem>
            <FormItem label="封面" {...formItemLayout}  extra="封面大小不超过2M，画面清晰，建议尺寸比例为3：2">
